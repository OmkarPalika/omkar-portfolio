...
export default function ProjectsSection() {
  const projects: Project[] = [
    ...
    },
    {
      ...
      projectLink: "https://www.linkedin.com/in/omkar-palika",
      textColor: ["text-yellow-400", "text-orange-600", "text-orange-400"],
    },
    {
      id: 5,
      name: "Portfolio",
        ...
        {projects.map((project) => (
          ...
          >
            <div className="relative h-64">
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent z-10 transition-all duration-700 ease-in-out group-hover:opacity-75 scale-105 group-hover:scale-100"></div>
              <Image
                src={project.image}
                alt={project.name}
                fill
            ...
            <div className="p-6">
              ...
              <div className="flex items-center gap-4 text-gray-400 text-sm mb-6">
                {project.tech.map((tech, index) => (
                  <span
                    key={index}
                    className={`text-2xl ${project.textColor[index]} translate-y-4 transition-all duration-400 ease-out hover:translate-y-0`}
                  >
                    {tech}
                  </span>
                ))}
