...
const SkillsCard = dynamic(() => import("@/components/SkillsCard"), { ssr: false });
const MainProfile = dynamic(() => import("@/components/MainProfile"), { ssr: false });
...
const ExperienceSection = dynamic(() => import("@/components/sections/Ed-ExSection"), { ssr: false });
...
const SectionLoading = () => (
  <div className="w-full h-screen flex flex-col items-center justify-center bg-gradient-to-b from-transparent to-gray-50 dark:to-gray-900">
    ...
    <p className="text-sm text-gray-600 dark:text-gray-400 animate-pulse">Loading content...</p>
...
export default function Home() {
  ...
  const renderHomeSection = () => (
    <section id="home" className="pt-5 md:pt-8 lg:pt-10 pb-10 md:pb-16 lg:pb-20 min-h-screen w-full">
  ...
  const renderSection = (id: string, Component: React.ComponentType, className?: string) => (
    <section id={id} className={`container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ${className || ""}`}>
  ...
  return (
    <main className="relative">
      ...
      {renderSection("services", ServicesSection, "mt-8 sm:mt-12 md:mt-16 lg:mt-20")}
